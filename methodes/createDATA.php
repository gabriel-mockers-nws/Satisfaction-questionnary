...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $donnee72 = $_POST['note-satg3'];
    $donnee73 = getPost('Remarque-35');
    $donnee74 = $_POST['note-satg4'];
    $donnee75 = getPost('Remarque-36');
    $donnee76 = $_POST['note-satg5'];
    $donnee77 = getPost('Remarque-37');
    $donnee78 = $_POST['note-satg6'];
    $donnee79 = getPost('Remarque-38');
    $donnee80 = $_POST['note-satg-1'];
    $donnee81 = getPost('Remarque-39');
    $donnee82 = getPost('Remarque-40');
    $donnee83 = $_POST['projet-futur'];
    $donnee84 = getPost('raison-non');
    $donnee85 = getPost('meme-maison');
    $donnee86 = $_POST['thematique'];
    $donnee87 = getPost('laquelle');
    $donnee88 = getPost('Remarque-41');


    $stmt = $pdo->prepare("INSERT INTO classe (constructionnotes, contructiontext, administratifnote, administratiftext, organisationtext, transportbool, compagnietext, satisfaittext, raisontext, transporteurtext, satisfactionautretext, premierressentittext, accueilresponsablenote, accueilresponsabletext, accueilagentsnote, accueilagentstext, qualitemaisongeneralenote, propretegeneralenote, propretegeneraletext, chambrenote, chambretext, rangementsnote, rangementtext, sanitairesnotes, sanitairestext, chauffagenote, chauffagetext, salletravailnote, salletravailtext, sallemangernote, sallemangertext, exterieursnote, exterieurstext, equipementsbool, manquestext, qualplatmidisoirnote, qualplatmidisoirtext, quantitenote, quantitetext, petidejnote, petitdejtext, goutersnote, goutertext, varmenusnote, varmenustext, regimenote, regimetext, presservicenote, presservicetext, rythmetext, thematiquetext, regiontext, ameliorationstext, leverptidejnote, leverptidejtext, gestrepasnote, gestrepastext, tempslibresnote, tempslibrestext, douchesnote, douchestext, couchertext, outilspedagobool, remarquestext, acpeadjointnote, acpeadjointtext, acpeequipeanimnote, acpeequipeanimtext, acpeintervnote, acpeintervtext, disecadjointnote, disecadjointtext, disecequipeanimnote, disecequipeanimtext, desecintervnote, disecintervtext, satisfglobnote, satifglobtext, attentesnote, attentetext, exploittext, projetfuturbool, raisonsnotext, mememaisonbool, thematiquebool, laquelle, datefuture) VALUES (" . rtrim(str_repeat('?,', 88), ',') . ")");

    $stmt->execute([
        $donnee, $donnee2, $donnee3, $donnee4, $donnee5, $donnee6, $donnee7, $donnee8, $donnee9, $donnee10, 
        $donnee11, $donnee12, $donnee13, $donnee14, $donnee15, $donnee16, $donnee17, $donnee18, $donnee19, $donnee20,
        $donnee21, $donnee22, $donnee23, $donnee24, $donnee25, $donnee26, $donnee27, $donnee28, $donnee29, $donnee30, 
        $donnee31, $donnee32, $donnee33, $donnee34, $donnee35, $donnee36, $donnee37, $donnee38, $donnee39, $donnee40,
        $donnee41, $donnee42, $donnee43, $donnee44, $donnee45, $donnee46, $donnee47, $donnee48, $donnee49, $donnee50,
        $donnee51, $donnee52, $donnee53, $donnee54, $donnee55, $donnee56, $donnee57, $donnee58, $donnee59, $donnee60, 
        $donnee61, $donnee62, $donnee63, $donnee64, $donnee65, $donnee66, $donnee67, $donnee68, $donnee69, $donnee70,
        $donnee71, $donnee72, $donnee73, $donnee74, $donnee75, $donnee76, $donnee77, $donnee78, $donnee79, $donnee80,
        $donnee81, $donnee82, $donnee83, $donnee84, $donnee85, $donnee86, $donnee87, $donnee88
    ]);
